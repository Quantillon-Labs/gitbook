...
Before you sign in, we make these Terms available for review. By signing the wallet authentication message that expressly refers to these Terms, you agree to the version identified in that message. If you act for an organization, you confirm that you have authority to accept these Terms on its behalf. You can save or print these Terms for your records. If you do not agree, do not sign that acceptance message or use features requiring acceptance.

Connecting a wallet alone does not constitute acceptance. A sign-in signature authenticates your wallet and records your acceptance; it does not itself authorize a transfer of assets or a blockchain transaction. Transactions and token spending approvals require separate wallet authorization.

These Terms govern our relationship with you. The protocol's smart contracts determine how blockchain operations execute, but their execution does not override mandatory law or eliminate legal remedies.

Our [Privacy Policy](privacy-policy.md) explains how personal data is processed. Acknowledgment of that policy is not consent to all processing activities. Where separate consent is required, we will request it separately.
...
You must not use the Interface where doing so is prohibited by laws applicable to you or Quantillon Labs, or where providing the relevant service to you would breach those laws. This includes applicable economic sanctions, asset-freezing measures and trade restrictions. Depending on their scope and jurisdiction, relevant measures may include those of France, the European Union, the United Nations, the United Kingdom and the United States.

You must not use the Interface if an applicable restriction prohibits dealings with you, an entity that owns or controls you, or a person for whom you act. You must not access a feature from, or on behalf of a person in, a country or territory where the applicable restrictions prohibit providing that feature. A sanction affecting a particular person or sector does not, by itself, mean that every resident of a country is prohibited.

We may limit the availability of particular features by jurisdiction or user category to meet legal requirements. Any additional contractual eligibility restrictions will be identified before you are asked to accept the affected feature's terms. Technical access to the Interface is not confirmation that you are eligible to use every feature.
...
Review the domain, message, network, recipient, contract address, amount and requested permission before signing. Token spending approvals may remain active until revoked separately; signing out of the Interface does not revoke them.
...
Some protocol functions depend on services or authorized actors responsible for matters such as price publication, hedging, yield collection, parameter changes, upgrades and emergency controls. These functions can affect availability and execution. The use of smart contracts does not mean that every part of the system is immutable or operates without human intervention.
...
QEURO is designed to reference the euro. Its market price, the assets available on redemption and their value may differ from expectations. A displayed reference price does not guarantee that you can sell or redeem a particular amount at that price, at a particular time or through a particular venue.

Execution depends on the relevant smart contracts and available collateral, liquidity, prices, limits and safeguards. A request may revert, be delayed or become unavailable. A quote is an estimate unless expressly identified as binding. Network conditions and price movements may affect the outcome within the transaction's authorized parameters.
...
Yield depends on strategy performance, protocol allocations, hedging and funding costs, fees and the timing of collection and release. An advertised or displayed annual percentage yield is an estimate or historical indicator, as described alongside it. It is not a guaranteed return, a daily payment to your wallet or a promise that yield will remain positive.

For vaults using the current share-value release mechanism, collected yield is allocated and released into the redeemable value of shares over time. On redemption, you receive the amount then available for those shares under the applicable contract. Uncollected or unreleased yield is excluded, and redeemed shares do not participate in later releases.
...
We will make the applicable pricing information available before you authorize an operation. Review the transaction summary and wallet request. Network fees are determined by the network and may be incurred even if a transaction fails; whether a refund or other remedy is available depends on the cause and applicable law.

Signing the off-chain authentication message does not itself incur a blockchain network fee. Any separate blockchain transaction requested by your wallet, including one needed by a particular wallet configuration, must be reviewed separately.
...
- **Smart contract and security risk:** errors, exploits, compromised signing keys, malicious approvals or failures in upgrades can cause loss or make assets inaccessible. Audits and monitoring reduce some risks but do not eliminate them.
- **Collateral and price risk:** QEURO and its collateral can lose value or depart from their reference values. Collateral issuers or providers may freeze assets, restrict redemption or fail to meet obligations.
- **Hedging and counterparty risk:** foreign-exchange hedges can be incomplete, delayed, costly or ineffective. Trading venues, counterparties or infrastructure can fail, and positions may be liquidated.
- **Liquidity and strategy risk:** a vault or underlying lending or yield strategy may suffer losses, lack available liquidity or restrict withdrawals. You may receive less than you deposited.
- **Oracle and infrastructure risk:** incorrect or stale prices, network congestion, sequencer outages, reorganizations, failed automation or service interruptions may affect execution and asset availability.
- **Transaction and interoperability risk:** ordering, front-running, slippage, mistaken addresses or networks, and failures of bridges or messaging systems used by an operation or strategy may cause loss. A confirmed operation may be technically irreversible.
- **Administrative and governance risk:** authorized actors may change permitted parameters, upgrade contracts or activate emergency controls. Compromise, error or misuse of these powers can affect assets and access.
- **Legal and tax risk:** applicable rules or their interpretation may change, affecting availability, obligations or the treatment of an asset or activity.
...
Report suspected vulnerabilities to support@quantillon.money. Any testing must remain within the scope of an applicable authorization or published security program; this clause does not grant permission to access another person's assets or systems.
...
We may act immediately where delay would create a material security or legal risk. We will provide information afterward where feasible and lawful. For a planned discontinuation of a service, we will provide reasonable advance notice and information about available exit arrangements, subject to applicable law.

Restricting Interface access does not, by itself, transfer ownership of your assets to us. However, a protocol pause, liquidity constraint or other contract-level restriction may also affect withdrawals. We do not promise that an alternative means of interacting with a contract will always be available or lawful.
...
We do not guarantee a particular price, yield or uninterrupted access. The existence of protocol or third-party risk does not automatically exclude our responsibility where our own conduct contributed to a loss or where the law makes us responsible.
...
For assistance: **support@quantillon.money**.
