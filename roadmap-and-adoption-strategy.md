...
| 🔒 Security audits & remediation (audit fixes deployed on-chain June 2026) | ✅ Completed |
...
The items below are directional targets, **subject to governance decisions, market depth, hedger participation, and protocol economics** — not commitments.
...
* 🌐 Cross-chain expansion beyond Base (subject to governance)
